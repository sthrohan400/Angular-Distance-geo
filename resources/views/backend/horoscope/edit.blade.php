...
<div class="col-md-6">
	<div class="box box-primary">
		<div class="box-header with-border">
			<h3 class="box-title"> Update Horoscope - Nepali -</h3>
		...
		@if($data['type'] == 'np')
			<form role="form" action="{{url('admin/horoscope/rashi/update',array($data['id']))}}" method="post" enctype="multipart/form-data" class="">
				...
				<div class="col-md-12">
				<img src="{{('/uploads/rashi/'.$data['image_name'])}}">
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="position" placeholder="Enter Position" name="position" value="{{$data['position']}}" required>
...
<div class="col-md-6">
	<div class="box box-primary">
		<div class="box-header with-border">
			<h3 class="box-title"> Update Horoscope - English -</h3>
