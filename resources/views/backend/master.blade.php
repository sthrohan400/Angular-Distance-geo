...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{URL::Asset('Backend_asset/plugins/iCheck/flat/orange.css')}}">
    <!-- Morris chart -->
    ...
    <link rel="stylesheet"
          href="{{URL::Asset('Backend_asset/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}">
...
<!-- datepicker -->
<script src="{{URL::Asset('Backend_asset')}}"></script>
<!-- Bootstrap WYSIHTML5 -->
